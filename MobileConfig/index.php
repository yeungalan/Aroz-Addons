...
$.get( "opr.php?filename=" + filename, function( str ) {
	...
	$("#subheader").html(data["PayloadOrganization"] + " " + '<span style="color:red">Unsigned</span>');
	...
	$.each( data["PayloadContent"], function( key, value ) {
		...
		var tmpDescription = "";
		var tmpItem = "";
		if(value["PayloadDisplayName"] == "Certificate"){
			$("#subheader").html(data["PayloadOrganization"] + " " + '<span style="color:green">Signed</span>');
		}
